package info.novatec.inspectitsamples.calculator;

/*
 This code was mainly written by Hemanth. B but adapted slightly to fit our demonstration needs
...
/**
 * Simple graphical calculator used for demonstration purposes of NovaSpy. The
 * code was initially written by Hemanth. B, but slightly adapted to fit our
 * demonstration needs.
 * 
 * @author Stefan Siegl / Hemanth. B
 */
public class Calculator extends JFrame implements ActionListener {
    ...
    double processLastOperator() throws DivideByZeroException {
        ...
        if (lastOperator.equals("/")) {
            result = divide(lastNumber, numberInDisplay);
        }

        if (lastOperator.equals("*")) {
            result = multiply(lastNumber, numberInDisplay);
        }

        if (lastOperator.equals("-")) {
            result = substract(lastNumber, numberInDisplay);
        }

        if (lastOperator.equals("+")) {
            result = add(lastNumber, numberInDisplay);
        }
    ...
    private double divide(double a, double b) throws DivideByZeroException {
        if (b == 0)
    ...
    public static void main(String args[]) {
        ...
        String[] test = new String[] {"b","c","d"};
        String[] test2 = new String[] {"b","d"};
        
        calci.myTestMethod(test);
        calci.myTestMethod(test2);
